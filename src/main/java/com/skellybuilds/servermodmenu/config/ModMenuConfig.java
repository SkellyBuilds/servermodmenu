package com.skellybuilds.servermodmenu.config;

import com.google.gson.annotations.SerializedName;
import com.skellybuilds.servermodmenu.config.option.*;
...
public class ModMenuConfig {
	public static final EnumConfigOption<SSorting> SSORTING = new EnumConfigOption<>("ssorting", SSorting.ASCENDING);
	...
	public static final BooleanConfigOption DISABLE_DRAG_AND_DROP = new BooleanConfigOption("disable_drag_and_drop", true);
	...
	public static final BooleanConfigOption BUTTON_UPDATE_BADGE = new BooleanConfigOption("button_update_badge", false);
	public static final BooleanConfigOption QUICK_CONFIGURE = new BooleanConfigOption("quick_configure", true);
	public static final BooleanConfigOption HIDE_RESTART_PROMPT = new BooleanConfigOption("hiderestartprompt", false);
	public static final StringSetConfigOption HIDDEN_SERVERS = new StringSetConfigOption("hidden_servers", new HashSet<>());
	public static final BooleanConfigOption SHOWHIDDENSERVERS = new BooleanConfigOption("show_hidden_servers", false);
	...
	public enum SSorting {
		@SerializedName("ascending")
		ASCENDING(Comparator.comparing(SMod -> SMod.meta.name.toLowerCase(Locale.ROOT))),
		@SerializedName("descending")
		DESCENDING(ASCENDING.getComparator().reversed());

		Comparator<SMod> comparator;

		SSorting(Comparator<SMod> comparator) {
			this.comparator = comparator;
		}

		public Comparator<SMod> getComparator() {
			return comparator;
		}
	}
